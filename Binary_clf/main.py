...
if __name__ == '__main__':
    ...
    if args.mode == 'train':  ## for train mode
        ...
        cv2.imwrite('/data/workspace/vfuser/sungjoo/Binary_clf/image_view/'+str(index)+'.jpg',res[0][0][0].numpy())
        index +=1
        ...
        for epoch in range(args.nb_epoch):
            ...
            # else:
            #     print("\n")
        # torch.save(model.state_dict(), os.path.join(args.exp, 'epoch_%03d_val_loss_%.4f_val_f1_%.4f.pth'%(epoch, val_loss, val_f1)))
            torch.save(model.state_dict(), os.path.join('/data/workspace/vfuser/sungjoo/Binary_clf/exp/GE', 'epoch_%03d_val_loss_%.4f_val_f1_%.4f.pth'%(epoch, val_loss, val_f1)))
